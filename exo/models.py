...
model_cards = {
  ...
  "qwen-2.5-72b": {
    "layers": 80,
    "repo": {
      "MLXDynamicShardInferenceEngine": "mlx-community/Qwen2.5-72B-4bit",
  ...
  "qwen-2.5-math-72b": {
    "layers": 80,
    "repo": {
      "MLXDynamicShardInferenceEngine": "mlx-community/Qwen2.5-Math-72B-4bit",
  ...
  "phi-3.5-mini": {
    "layers": 32,
    "repo": {"MLXDynamicShardInferenceEngine": "mlx-community/Phi-3.5-mini-4bit",},
  },
  "phi-4": {
    "layers": 66,
  ...
  "medusa-v1.0-vicuna-7b-v1.5": {
    ...
    "is_medusa": True,
    "repo": {
      "MLXDynamicShardInferenceEngine": "FasterDecoding/medusa-v1.0-vicuna-7b-v1.5",
      "TinygradDynamicShardInferenceEngine": "FasterDecoding/medusa-v1.0-vicuna-7b-v1.5",
      "TorchDynamicShardInferenceEngine": "FasterDecoding/medusa-v1.0-vicuna-7b-v1.5"
    },
  },
}
...
pretty_name = {
  ...
  "medusa-v1.0-vicuna-7b-v1.5": "Medusa Vicuna 7B v1.5",
}
